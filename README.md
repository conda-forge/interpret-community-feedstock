About interpret-community-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/interpret-community-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/interpret-community-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add interpret-community
# for installing globally
pixi global install interpret-community
```
...
It is possible to list all of the versions of `interpret-community` available on your platform:
...
```
pixi search interpret-community --channel conda-forge
```
